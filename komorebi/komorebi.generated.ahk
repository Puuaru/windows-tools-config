...
Run, komorebic.exe workspace-rule exe Obsidian.exe 0 3, , Hide
Run, komorebic.exe workspace-rule exe Discord.exe 0 3, , Hide
Run, komorebic.exe workspace-rule exe Spotify.exe 0 3, , Hide
...
Run, komorebic.exe identify-tray-application exe "Clash for Windows.exe", , Hide
Run, komorebic.exe identify-tray-application exe uTools.exe, , Hide
Run, komorebic.exe identify-tray-application exe Telegram.exe, , Hide
Run, komorebic.exe identify-tray-application exe Spotify.exe, , Hide
Run, komorebic.exe identify-tray-application exe qbittorrent.exe, , Hide
Run, komorebic.exe identify-tray-application exe WindowsTerminal.exe, , Hide

; Identify applications that have overflowing borders
Run, komorebic.exe identify-border-overflow exe Discord.exe, , Hide
Run, komorebic.exe identify-border-overflow exe Kook.exe, , Hide